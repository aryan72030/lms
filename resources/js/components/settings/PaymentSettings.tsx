...
import { AlertCircle, CheckCircle, Loader2, TestTube, CreditCard, DollarSign, RefreshCw } from 'lucide-react';
...
export default function PaymentSettings({ settings }: Props) {
    ...
    const testPayPalConnection = async () => {
        if (!formData.paypal_client_id || !formData.paypal_client_secret) {
            setTestResult({
                success: false,
                message: 'Please enter PayPal Client ID and Client Secret first.'
            });
                ...
                <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            ...
                            <p className="text-sm text-muted-foreground">Allow students to pay for courses using PayPal</p>
                        </div>
                        <Switch
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Select
                                ...
                                onValueChange={(value) => handleInputChange('paypal_mode', value)}
                                disabled={!formData.paypal_enabled}
                            >
                                <SelectTrigger>
                                    <SelectValue />
                        ...
                        <div className="space-y-2">
                            ...
                            <Select
                                ...
                                onValueChange={(value) => handleInputChange('paypal_currency', value)}
                                disabled={!formData.paypal_enabled}
                            >
                                <SelectTrigger>
                                    <SelectValue />
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="paypal_webhook_id">PayPal Webhook ID (Optional)</Label>
                        <Input
                        ...
                        <p className="text-sm text-muted-foreground">
                            Used for real-time payment notifications. Configure in your PayPal Developer Dashboard.
                        </p>
                    </div>

...
export default function PaymentResult({ success, message, course, enrollment_id, payment_amount, cancelled }: Props) {
    const getIcon = () => {
        if (success) {
                        ...
                        <CardContent className="space-y-6">
                                    ...
                                    <div className="bg-white rounded-lg p-4 border">
                                        ...
                                        {payment_amount && (
                                            <p className="text-sm text-muted-foreground">
                                                Amount Paid: <span className="font-semibold">${payment_amount}</span>
                                            </p>
                                        )}
                                    </div>
                                </div>
                            ...
                            <div className="space-y-3">
                                {success && enrollment_id ? (
                                    <>
                                        <Link href={`/student/enrollments/${enrollment_id}`}>
                            ...
                            {success && (
                                <div className="text-sm text-muted-foreground bg-white rounded-lg p-3 border">

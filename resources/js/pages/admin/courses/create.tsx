...
export default function AdminCourseCreate({ categories, instructors, difficultyLevels }: Props) {
        ...
        <AppLayout breadcrumbs={[
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Create New Course (Admin)</h1>
                        <p className="text-gray-600">Create a new course on behalf of an instructor</p>
                    </div>
                </div>

                ...
                <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                    <div>
                        ...
                        <p className="mt-1 font-medium text-slate-500">
                            System-wide overview and management metrics.
                        </p>
                    </div>
                </div>
                        ...
                        <CardContent className="p-0">
                            {pending_approvals.length > 0 ? (
                                    ...
                                    {pending_approvals.map((course: any) => (
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-50 text-xs font-bold text-amber-600">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <Link href="/admin/courses">
                                                    <Button
                                                        size="sm"
                                                        variant="ghost"
                                                        className="h-8 w-8 rounded-lg p-0 hover:bg-amber-100 hover:text-amber-700"
                                                    >
                                ...
                                <div className="p-10 text-center">
                                    ...
                                    <p className="text-sm font-bold tracking-tight text-slate-400 uppercase">
                                        All caught up!
                                    </p>
                                </div>
                            )}
                            ...
                            {recent_users.length > 0 ? (
                                <div className="divide-y divide-slate-100">
                                    {recent_users.map((user) => (
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-100 text-xs font-bold text-slate-600 uppercase">
                                                    {user.name
                                                        .split(' ')
                                                        .map((n) => n[0])
                                                        .join('')}
                                            ...
                                            <div className="flex items-center gap-3 text-right">
                                                <div className="flex flex-col items-end">
                                                    <Badge
                                                        className={`border px-2 py-0 text-[9px] font-black uppercase ${getRoleBadgeColor(user.role)}`}
                                                    >
                                                        {user.role}
                                                    </Badge>
                                        ...
                                        (enrollment: any, index: number) => (
                                            ...
                                            >
                                                ...
                                                <div className="text-right">
                                                    <Badge
                                                        className={`border px-2 py-0 text-[9px] font-black uppercase ${enrollment.status === 'Active' ? 'border-emerald-100 bg-emerald-50 text-emerald-700' : 'border-slate-100 bg-slate-50 text-slate-700'}`}
                                                    >
                                                        {enrollment.status}
                                                    </Badge>

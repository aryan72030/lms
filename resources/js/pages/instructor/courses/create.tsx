...
import { ArrowLeft, Plus, Trash2, Image as ImageIcon, Languages, Target, ListChecks } from 'lucide-react';
...
export default function InstructorCourseCreate({ categories, difficultyLevels }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post('/instructor/courses', {
            forceFormData: true,
            onSuccess: () => courseMessages.success('create'),
            onError: () => courseMessages.error('create'),
        });
    };
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600">Design and launch your professional learning experience</p>
                    </div>
                </div>

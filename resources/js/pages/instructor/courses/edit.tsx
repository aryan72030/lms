...
import { Image as ImageIcon, Languages, ListChecks, Plus, Target, Trash2 } from 'lucide-react';
...
export default function InstructorCourseEdit({ course, categories, difficultyLevels }: Props) {
    ...
    const { data, setData, post, processing, errors } = useForm<FormData>({
        ...
        target_audience: course.target_audience && course.target_audience.length > 0 ? course.target_audience : [''],
        thumbnail: null,

...
export default function InstructorLessonEdit({ course, lesson }: Props) {
    ...
    const { data, setData, put, processing, errors } = useForm<FormData>({
        ...
        quiz_passing_score: lesson.quiz_data?.settings?.passing_score?.toString() || '70',
        quiz_attempts_allowed: lesson.quiz_data?.settings?.attempts_allowed?.toString() || '3',
        is_final_quiz: lesson.quiz_data?.settings?.is_final_quiz || false,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/instructor/courses/${course.id}/lessons/${lesson.id}`, {
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <textarea
                                ...
                                required
                            />
                            {errors.assignment_instructions && <p className="text-red-600 text-sm mt-1">{errors.assignment_instructions}</p>}
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="100"
                                />
                                {errors.assignment_max_score && <p className="text-red-600 text-sm mt-1">{errors.assignment_max_score}</p>}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="7"
                                />
                                {errors.assignment_due_days && <p className="text-red-600 text-sm mt-1">{errors.assignment_due_days}</p>}
                            </div>
                        </div>
                    </div>
                );
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            { title: 'Edit Lesson', href: `/instructor/courses/${course.id}/lessons/${lesson.id}/edit` }
        ]}>

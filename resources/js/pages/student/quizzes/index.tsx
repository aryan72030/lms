...
const QuizScoreDisplay = ({ quiz }: { quiz: Quiz }) => {
    const { student_stats } = quiz;
...
export default function StudentQuizzesIndex({ quizzes, enrollments }: Props) {
    ...
    const uniqueCourseEnrollments = Array.from(
        new Map(
                ...
                <div className="rounded-lg bg-white p-4 shadow">
                    <div className="flex items-center gap-4">
                        ...
                        >
                            ...
                            {uniqueCourseEnrollments.map((enrollment) => (
                                <option
                                    key={enrollment.id}
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <ul className="space-y-1 text-sm text-blue-800">
                                <li>
                                    • Final quizzes must be passed to complete
                                    the course
                                </li>
                                <li>
                                    • You can retake quizzes until you reach the
                                    attempt limit
                                </li>
                                <li>
                                    • Your best score is always kept as your
                                    final grade
                                </li>
                                <li>
                                    • Time limits are enforced - prepare before
                                    starting
                                </li>
                            </ul>
                        </div>
